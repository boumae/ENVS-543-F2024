...
```{r}
   ggplot( data, aes( Suitability,
                      MFRatio)) +
      labs ( title = "Correlation Between Habitat Suitability and the Ratio of Males to Female Beetles",
             x = "Habitat Suitability",
             y = "Ratio of Males to Female") +
...
```{r}
data |>
  st_transform( 6367 ) -> mexico12n

  #st_bbox( mexico12n )
  
  ggplot( mexico12n, aes(color= MFRatio,
                  size = Suitability) ) + 
  geom_sf( )
```
